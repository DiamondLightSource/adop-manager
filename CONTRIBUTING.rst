...
.. _GitHub: https://github.com/dls-controls/adop_manager/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/adop_manager.git
    $ cd adop_manager
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/dls-controls/adop_manager/releases
